...
Visit the deployed portfolio at **[rafin2312.github.io/updatePortfolio](https://rafin2312.github.io/updatePortfolio/)**.

## Highlights

| Area | What the portfolio presents |
| --- | --- |
| **Software Engineering** | Java, C++, object-oriented programming, algorithms, data structures, and practical application design. |
| **Artificial Intelligence & ML** | Applied machine learning, predictive modelling, deep learning, and explainable AI. |
| **Computer Networking** | Cisco networking, protocol behaviour, infrastructure design, packet analysis, latency, and traffic flow. |
| **Research** | PlantVisionBD, a plant disease detection study using EfficientNetV2L with Grad-CAM and SHAP analysis. |
| **Professional Profile** | IT operations experience, technical support, stakeholder communication, and infrastructure reliability. |
| **Creative Work** | Travel and landscape photography from trekking experiences in Bangladesh. |
...
| --- | --- | --- |
| **Enterprise Java System** | An object-oriented software application focused on scalable data structures and runtime performance. | Java, OOP |
| **Advanced Algorithmic Suite** | Algorithmic problem-solving work involving dynamic programming, resource allocation, complexity, and memory analysis. | C++, Data Structures |
| **Network Infrastructure Project** | An in-progress hands-on project involving topology design, protocols, traffic behaviour, packet loss, and latency analysis. | Networking, Cisco, Protocols |
| **Student Management System** | A command-line Java application for managing student records. | Java, OOP, Console |
| **Exam Management System** | A JavaFX desktop application for managing exams through an event-driven graphical interface. | Java, JavaFX, GUI |
...
| Layer | Technologies |
| --- | --- |
| **Markup** | HTML5, semantic sections, accessible labels, and responsive viewport metadata |
| **Styling** | CSS3, custom properties, Flexbox, CSS Grid, gradients, transitions, animations, and glassmorphism effects |
| **Interactivity** | Vanilla JavaScript, DOM APIs, `IntersectionObserver`, scroll state handling, animated counters, typing effects, navigation controls, pagination, and lightbox logic |
| **Typography** | Space Grotesk, Inter, and JetBrains Mono via Google Fonts |
...
3. Select **Pages** under the repository configuration.
4. Choose the deployment source and the `main` branch.
...
| --- | --- |
| In progress | Complete and publish the network infrastructure project with a dedicated repository link. |
| Planned | Add dedicated project pages with screenshots, architecture notes, and implementation details. |
| Planned | Add a downloadable project résumé or case-study format for selected work. |
| Planned | Improve image optimisation and add more detailed alternative text for gallery content. |
| Planned | Add automated HTML, accessibility, and link checks to the repository workflow. |
...
| Channel | Link |
| --- | --- |
| **Email** | [mdkamranhasanrafin@gmail.com](mailto:mdkamranhasanrafin@gmail.com) |
| **GitHub** | [github.com/rafin2312](https://github.com/rafin2312) |
| **LinkedIn** | [linkedin.com/in/rafin2312](https://www.linkedin.com/in/rafin2312) |
| **Instagram** | [@hardin_2312](https://instagram.com/hardin_2312) |
...
[1]: https://github.com/rafin2312/updatePortfolio "updatePortfolio source repository"

[2]: https://rafin2312.github.io/updatePortfolio/ "Rafin's live portfolio"

[3]: https://github.com/rafin2312 "Rafin's GitHub profile"

[4]: https://github.com/rafin2312/updatePortfolio/blob/main/plantvisionbd-paper.pdf "PlantVisionBD research paper"

[5]: https://github.com/rafin2312/updatePortfolio/blob/main/MD_Kamran_Hasan_Rafin_CV.pdf "Md. Kamran Hasan Rafin CV"
